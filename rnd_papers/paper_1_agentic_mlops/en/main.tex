...
\begin{figure}[htbp]
\centering
% MERMAID_DIAGRAM_PLACEHOLDER: Flowchart showing User -> LLM Agent -> MCP Server -> FastAPI Gateway -> Celery Broker -> Invoker Daemon -> Ephemeral Executor Container. The subagent MUST generate this using subgraphs or grid structures so it is visually balanced (squarish) rather than one long horizontal or vertical line, perfectly fitting within a SINGLE LaTeX column.
\end{figure}
