...
\begin{figure}[h]
    ...
    \caption{A bar chart comparing OOM crashes and Peak Memory Usage between the Legacy Daemon Setup and the Invoker-Executor Pattern}
    \label{fig:barchart}
\end{figure}
...
This architecture operates under a Dual Licensing Model (PolyForm Noncommercial / AGPLv3). The complete source code, deployment scripts (\texttt{docker-compose up -d}), and architectural blueprints are available in the official wisrovi-suit repository at \url{https://github.com/wisrovi/w-cli}. 
