...
\begin{center}
    \texttt{[Imágenes Origen/Objetivo] $\to$ [Embeddings InceptionV3] $\to$ [Cálculo de FID] $\to$ [Complejidad de Escena (SC)] $\to$ [Regresión OLS / Bootstrap] $\to$ [Decisión JSON de Puerta (Gate)]}
\end{center}
