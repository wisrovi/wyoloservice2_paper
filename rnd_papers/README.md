...
| **3** | **Automated XAI** | Automated generation of post-training explanatory reports using EDA and local LLM models (OpenCode). | [DRAFT.md](./paper_2_automated_xai/en/DRAFT.md) |
| **6** | **Robustness & Adversarial Attacks** | Quantifying YOLO model robustness via FGSM attacks, noise resilience, and MC Dropout uncertainty. | [DRAFT.md](./paper_3_robustness_adversarial/en/DRAFT.md) |
| **7** | **Cross-Domain Generalization** | FID-based domain shift detection and hardware profiling for deployment feasibility. | [DRAFT.md](./paper_4_cross_domain_generalization/en/DRAFT.md) |
| **9** | **LLM Research Reporting** | Automated scientific report generation using local LLMs (OpenCode/DeepSeek-V4). | [DRAFT.md](./paper_5_llm_research_reporting/en/DRAFT.md) |
