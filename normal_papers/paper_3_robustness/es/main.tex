...
Los scripts y sus resultados empíricos en CSV están en la carpeta \texttt{evidencias/} de este documento. Este ecosistema opera bajo Licencia Dual (PolyForm Noncommercial / AGPLv3, compatible con normativas de publicación de IEEE). El código fuente está disponible en GitHub en \url{https://github.com/wisrovi/}. Para reproducir las métricas, ejecute \texttt{python benchmark\_robustness.py} localmente.
