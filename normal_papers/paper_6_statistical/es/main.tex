...
El \texttt{OutlierFailureAnalyzer} analizó el conjunto de validación usando heurísticas de umbrales de confianza para aislar errores sistemáticos. Como se muestra en la Tabla \ref{tab:failure}, la taxonomía subraya los falsos positivos como un reto. Reconocemos explícitamente que con $N=128$ en el subconjunto COCO128, esta taxonomía heurística carece de potencia estadística para formular afirmaciones generalizables sobre modos de fallo verdaderos IoU-vs-GT, y debe considerarse estrictamente como una guía subrogada para bucles subsecuentes de Active Learning.
...
Los scripts y sus resultados empíricos estrictamente ejecutados en CSV están publicados en la carpeta \texttt{evidencias/} de este documento. Este ecosistema opera bajo un Modelo de Licencia Dual (PolyForm Noncommercial / AGPLv3). El código fuente está disponible en GitHub en \url{https://github.com/wisrovi/wyoloservice2_production}. Para reproducir las métricas exactamente, ejecute \texttt{python benchmark\_statistical.py} localmente.
