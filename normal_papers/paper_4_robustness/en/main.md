...
1. **Aleatoric Uncertainty:** Data-inherent noise, estimated via mean predictive variance.
2. **Epistemic Uncertainty:** Model ignorance, estimated via the variance of the mean predictions across passes.
