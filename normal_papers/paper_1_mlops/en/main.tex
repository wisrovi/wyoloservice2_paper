...
Ray Tune \cite{liaw2018tune, moritz2018ray} and Kubeflow \cite{bisong2019kubeflow} orchestrate HPO but suffer from cold-start overheads. Modern GPU scheduling techniques like Tiresias \cite{gu2019tiresias}, Optimus \cite{peng2020optimus}, and Themis \cite{zhang2020themis} improve resource fairness \cite{li2020heterogeneous} but are rarely coupled directly with HPO isolation. Recent advancements post-2021, such as Topology-Aware \cite{amaral2017topology}, MLaaS in the Wild \cite{weng2022mlaas}, and resource-aware ephemeral isolation scheduling \cite{zhang2022specon, flowcon2023}, propose advanced topological scheduling and dynamic workload redistribution, yet they often overlook the specific ephemeral isolation needs of HPO workloads. Frameworks like FLAML \cite{wang2021flaml}, Hyperband \cite{li2018hyperband}, BOHB \cite{falkner2018bohb}, and HPO-B \cite{arango2021hpob} enhance search efficiency, while CMA-ES \cite{hansen2016cma} optimizes sweeps. MLOps platforms (MLflow \cite{zaharia2018accelerating}, ClearML) track experiments but offload scheduling. NeuralForge directly manages lifecycle via ephemeral containers leveraging cgroups v2.
