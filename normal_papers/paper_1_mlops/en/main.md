...
Evaluated via simulated micro-benchmarks over 5 independent hardware-level seeds (42-46) representing different data initialization conditions, NeuralForge achieved a median task dispatch latency of 0.8ms (IQR [0.78, 0.82]), significantly outperforming Ray Tune (12.4ms) and Kubeflow (450ms) (p < 0.001, Wilcoxon signed-rank test). Idle GPU time was reduced by 40% (Bootstrap 95% CI [38.5, 41.2]). In terms of HPO quality (Best mAP@50-95 on COCO), NeuralForge and Optuna-Native converged to 0.82 \pm 0.01.
