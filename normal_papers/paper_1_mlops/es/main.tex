...
La optimización de hiperparámetros (HPO) para modelos de aprendizaje profundo, como YOLO \cite{jocher2020yolov5}, requiere la ejecución de miles de ensayos. Como un cuello de botella industrial crítico, los frameworks monolíticos tradicionales tienen dificultades para gestionar el aislamiento del estado entre ensayos, lo que culmina en errores de falta de memoria (OOM) \cite{shi2021understanding}. Las plataformas existentes introducen sobrecarga de red o carecen de un aislamiento estricto de GPU \cite{liaw2018tune, burns2016borg}. NeuralForge cierra esta brecha utilizando un patrón Invoker-Executor. Al emplear Celery \cite{sobolev2015celery} y PostgreSQL \cite{momjian2001postgresql}, enruta dinámicamente tareas a través de colas de GPU priorizadas mientras se ejecuta dentro de contenedores Docker efímeros \cite{merkel2014docker}.

\section{Trabajo Relacionado}
Ray Tune \cite{liaw2018tune, moritz2018ray} y Kubeflow \cite{bisong2019kubeflow} orquestan HPO pero sufren de sobrecargas de inicio en frío. Las técnicas modernas de programación de GPU como Tiresias \cite{gu2019tiresias}, Optimus \cite{peng2020optimus} y Themis \cite{zhang2020themis} mejoran la equidad de recursos \cite{li2020heterogeneous}, pero rara vez se acoplan directamente con el aislamiento de HPO. Los avances recientes posteriores a 2021, como Topology-Aware \cite{amaral2017topology}, MLaaS in the Wild \cite{weng2022mlaas}, y la programación de aislamiento efímero sensible a los recursos \cite{zhang2022specon, flowcon2023}, proponen una programación topológica avanzada y una redistribución dinámica de la carga de trabajo, aunque a menudo pasan por alto las necesidades específicas de aislamiento efímero de las cargas de trabajo HPO. Frameworks como FLAML \cite{wang2021flaml}, Hyperband \cite{li2018hyperband}, BOHB \cite{falkner2018bohb} e HPO-B \cite{arango2021hpob} mejoran la eficiencia de la búsqueda, mientras que CMA-ES \cite{hansen2016cma} optimiza los barridos. Las plataformas MLOps (MLflow \cite{zaharia2018accelerating}, ClearML) realizan el seguimiento de los experimentos pero delegan la programación. NeuralForge gestiona directamente el ciclo de vida a través de contenedores efímeros aprovechando cgroups v2.
