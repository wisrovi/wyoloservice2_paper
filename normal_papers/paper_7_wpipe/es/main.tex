...
Los scripts y sus resultados en CSV están en la carpeta \texttt{evidencias/}. El código fuente de WPipe y los conjuntos de datos están disponibles en GitHub.
