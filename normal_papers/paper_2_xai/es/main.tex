...
Los scripts y los resultados empíricos estrictamente ejecutados en CSV (p. ej., \texttt{results\_xai\_deletion.csv}, \texttt{results\_xai\_insertion.csv}, \texttt{results\_tsne\_clusters.csv}) están publicados en la carpeta \texttt{evidencias/} de este paper. Este ecosistema opera bajo Licencia Dual (PolyForm Noncommercial / AGPLv3). Código en \url{https://github.com/wisrovi/}.
