...
[9] A.~e.~a. Agache, ``Firecracker: Lightweight virtualization for serverless applications,'' \emphUSENIX NSDI, 2020.

[10] M.~e.~a. Crosby, ``containerd: An industry-standard container runtime,'' in \emphCNCF, 2017.

[11] T.~Heo, ``Control groups v2,'' \emphLinux Kernel Documentation, 2017.

[12] Y.~e.~a. Wang, ``Performance and isolation analysis of runc, gvisor and kata containers,'' \emphCluster Computing, 2022.

[13] T.~e.~a. Young, ``The true cost of containing: A performance study of container runtimes,'' in \emphUSENIX HotCloud, 2019.
