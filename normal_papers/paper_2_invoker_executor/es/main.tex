...
\begin{table}[htbp]
\centering
\caption{Comparación de Estabilidad del Host y Latencia (prueba de estrés 72 horas)}
\label{tab:ablation}
\begin{tabular}{@{}lllll@{}}
\toprule
Métrica & Ejec. Directa & Ray (sin contenedor) & Kubernetes & Invocador-Ejecutor \\ \midrule
Caídas OOM Host & 18 & 11 & 0 & 0 \\
Reinicios Manuales Requeridos & 18 & 9 & 0 & 0 \\
Eliminaciones Contenedor/Job (contenidas) & 0 & 0 & 18 & 18 \\
Latencia Prom. Inicio Tarea & 2.1 s & 3.8 s & 14.2 s & 2.4 s \\ \bottomrule
\end{tabular}
\end{table}
...
\caption{Latencia de inicio y contención de caídas entre configuraciones.}
\label{fig:latency}
\end{figure}
